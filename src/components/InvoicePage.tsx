      ...
      <Page className="invoice-wrapper" pdfMode={pdfMode}>
        ...
        <View className="flex" pdfMode={pdfMode}>
          <View className="w-50" pdfMode={pdfMode}>
            ...
            />
             <EditableInput
              className="bold dark mb-5 mt-10"
              value="Sold By"
            ...
            <EditableInput
              ...
              value="Pan : 123456789123"
              onChange={(value) => handleChange('pan', value)}
              pdfMode={pdfMode}
            />
             <EditableInput
              className="bold dark mb-5"
              value="GST : 123456789451"
          ...
          <View className="w-50" pdfMode={pdfMode}>
            <EditableInput
              className="bold dark mb-5 right"
              placeholder="Invoice"
              value={invoice.title}
        ...
        <EditableInput
            ...
            />
        <EditableFileImage
              className="logo right mt-10"
              placeholder="Your Signature"
              value={invoice.logoo}
              width={invoice.logoWidth}
              pdfMode={pdfMode}
              onChangeImage={(value) => handleChange('logoo', value)}
              onChangeWidth={(value) => handleChange('logoWidthh', value)}
            />
        </view>
